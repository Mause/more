...
class Func2Delegate#if!H<A1, A2, R>#end {
	var _handlers:DoubleLinkedList<Func2<A1, A2, R>>;
	...
	public function add(handler:Func2<A1, A2, R>):Void {
		_handlers.push(handler);
	}
	
	public function remove(handler:Func2<A1, A2, R>):Void {
	...
	public function invoke(arg1:A1, arg2:A2):R {
		var current = _handlers.head;
		var result:R = null;
		while (current != null) {
			result = current.value(arg1, arg2);
		}
		return result;
	}
	
	public function invokeAll(arg1:A1, arg2:A2):ReadOnlyArray<R> {
		var current = _handlers.head;
		var result = new Array<R>();
		while (current != null) {
			result.push(current.value(arg1, arg2));
		}
		return new ReadOnlyArray(result);
	}
	
	public function iterator(arg1:A1, arg2:A2):Iterator<R> {
