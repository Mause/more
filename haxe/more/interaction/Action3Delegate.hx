...
class Action3Delegate#if!H<A1, A2, A3>#end {
	...
	public function add(handler:Action3<A1, A2, A3>):Void {
		_handlers.push(handler);
	}

	public function remove(handler:Action3<A1, A2, A3>):Void {
	...
	public function invoke(arg1:A1, arg2:A2, arg3:A3):Void
		for (handler in _handlers)
			handler(arg1, arg2, arg3)

	public function iterator(arg1:A1, arg2:A2, arg3:A3):Iterator<Void> {
